...
def test_post():
    ...
    driver.find_element(By.XPATH, "//input[contains(@placeholder,'Username')]").send_keys("Admin")
    time.sleep(1)
    driver.find_element(By.XPATH, "//input[contains(@placeholder,'Password')]").send_keys("admin1123")
    time.sleep(1)
    driver.find_element(By.XPATH, "//button[text()=' Login ']").click()
    time.sleep(2)
...
def test_lastaname():
    ...
    driver.find_element(By.CSS_SELECTOR, "a.oxd-main-menu-item[href='/web/index.php/pim/viewMyDetails']").click()
    time.sleep(2)
    driver.find_element(By.XPATH, "/html/body/div/div[1]/div[2]/div[2]/div/div/div/div[2]/div[1]/form/div[1]/div/div/div/div[2]/div[3]/div[2]/input").send_keys("2040-01-05")
    driver.find_element(By.XPATH, "//button[text()=' Save ']").click()
    driver.find_element(By.ID, 'oxd-toaster_1') #id da confirmação
    driver.quit()
